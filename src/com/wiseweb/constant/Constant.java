...
public class Constant {
	...
	//
	public static final String[] FILM_TYPE={"剧情","喜剧","爱情","动画","动作","恐怖",
		"惊悚","悬疑","冒险","科幻","犯罪","战争","纪录片","其它"};
	public static final String[] FILM_AREA={"美国","大陆","港台","罚过","英国","德国",
		"日本","韩国","印度","̩泰国","其它"};
	
	public static final String[] CONTENT = new String[] { "3月1日", "3月1日", "3月1日", "3月1日","3月1日", "3月1日", "3月1日", "3月1日"};
