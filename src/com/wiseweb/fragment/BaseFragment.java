...
//		View v = inflater.inflate(R.layout.messages_layout, container, false);
	...
	public static BaseFragment newInstance(Context context,String tag){
		...
		if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_CINEMA)){
			baseFragment = new CinemaFragment();
		}else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_FILM)){
		...
		}else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_MINE)){
