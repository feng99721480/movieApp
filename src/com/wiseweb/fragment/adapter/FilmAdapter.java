...
public class FilmAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, R.layout.film_item_layout, null); 
			holder = new ViewHolder();
			holder.imageView = (ImageView) convertView.findViewById(R.id.img_film_item);

			holder.imageView.setImageResource(mListFilmBean.get(position)
					.getImgId());

			holder.nameFilm = (TextView) convertView.findViewById(R.id.name_film_item);
			...
			holder.outline = (TextView)convertView.findViewById(R.id.film_outline);
			holder.outline.setText(mListFilmBean.get(position).getOutline());

			holder.filmShow = (TextView) convertView.findViewById(R.id.film_show);
			holder.filmShow.setText(mListFilmBean.get(position).getShow());

			holder.filmScore = (TextView) convertView.findViewById(R.id.film_score);
			holder.filmScore.setText(mListFilmBean.get(position).getScore());

			holder.buyTicket = (Button) convertView.findViewById(R.id.buy_filmticket);
			//holder.buyTicket.setText("��Ʊ");
