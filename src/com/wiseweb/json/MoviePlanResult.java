...
public class MoviePlanResult {
	...
	public void setPlans(List<MoviePlan> plans) {
		this.plans = plans;
	}
	...
	public String toString() {
		return "MoviePlanResult [action=" + action + ", status=" + status
				+ ", plans=" + plans + "]";
	}


	public static class MoviePlan{
		...
		public String toString() {
			return "MoviePlan [cinemaId=" + cinemaId + ", featureTime="
					...
					+ ", standardPrice=" + standardPrice + ", subtitle="
					+ subtitle + "]";
		}
