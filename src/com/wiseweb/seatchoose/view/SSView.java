package com.wiseweb.seatchoose.view;
...
public class SSView extends View {
	...
	/** 每个座位的高度 - 57 */
	private int ss_seat_current_height = 20;
	/** 每个座位的宽度 */
	private int ss_seat_current_width = 20;
	/** 座位之间的间距 */
	private int L = 5;
